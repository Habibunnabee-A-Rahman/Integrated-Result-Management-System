 ...
 * @author himal
 */
public class AddSchoolFrame extends javax.swing.JFrame {
    ...
    void alert2bGeneration(int c,String msg1,String msg2,String msg3,String btext1,String btext2,String parent){
        ...
        a2frm.passAddSchoolFrame(this, parent);
    ...
    void alertGeneration(int c,String msg1,String msg2,String msg3){
        ...
        afrm.passAddSchoolFrame(this,"addschoolframe");
    ...
    public AddSchoolFrame(String uni_id) {
        initComponents();
        this.uni_id = uni_id;
        try{
    ...
    private void initComponents() {
        ...
        setTitle("Add School");
        setPreferredSize(new java.awt.Dimension(414, 344));
        ...
        jPanel7.setPreferredSize(new java.awt.Dimension(70, 10));
        jPanel1.add(jPanel7);

        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/addschool_64.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        //ADD Button
        String school_id = jTextField1.getText().trim();
        String school_name = jTextField2.getText().trim();
        //String uni_accro = jTextField4.getText().trim();
        if(school_id.isEmpty() || school_name.isEmpty()){
        ...
        try {
            ...
            ps = connect.prepareStatement("INSERT INTO `t03_school` (`school_id`, `T01_id_fk`, `school_name`) VALUES (?,?,?);");
            ...
            alertGeneration(5,"School Entry Successful!!","","");
            jTextField1.setText("");
            jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSchoolFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSchoolFrame("default").setVisible(true);
            }
        });
    }
