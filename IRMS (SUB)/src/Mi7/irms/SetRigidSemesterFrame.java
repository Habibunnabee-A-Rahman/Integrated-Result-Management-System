 ...
 * @author himal
 */
public class SetRigidSemesterFrame extends javax.swing.JFrame {
 ...
 /*void alertGeneration(int c,String msg1,String msg2,String msg3){
    ...
    public SetRigidSemesterFrame(String idT06, String idT01,String token) {
        initComponents();
        ...
        try {
            ...
            if (select == 0) {
                SetRigidSemesterFrame evfrm = new SetRigidSemesterFrame(this.idT06, this.idT01,this.token);
    ...
    private void initComponents() {
        ...
        setTitle("Set Rigid Semester");
        setPreferredSize(new java.awt.Dimension(417, 378));
        ...
        jLabel1.setText("SET SEMESTER RIGID");
        jPanel1.add(jLabel1);
        ...
        jLabel5.setText("***Caution: Setting Semester Rigid Can NOT be Undone");
        jPanel7.add(jLabel5);
        ...
        setButton.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        setButton.setText("SET");
        setButton.setPreferredSize(new java.awt.Dimension(150, 35));
    ...
    private void setButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setButtonActionPerformed
        ...
        try {
            ...
            //check if any offered course is not register with teacher
            ps=connect.prepareStatement("SELECT * FROM `t15_offered_course` WHERE T14_id_fk= ? AND T16_id_fk IS NULL");
            ps.setString(1, T14_id[index]);
            ResultSet rs = ps.executeQuery();
            if(rs.next()){
                ImageIcon error = new ImageIcon(getClass().getResource("/icon/error_2_64.png"));
                JOptionPane.showMessageDialog(this, "All Offered Course are not registered with teacher!", "Error!", JOptionPane.ERROR_MESSAGE, error);
                return;
            }
            ...
            ps = connect.prepareStatement("UPDATE `t14_semester` SET `semester_status`=1,`start_date`= ? "
            ...
            JOptionPane.showMessageDialog(this, "Rigiding Semester Successful!", "Success!", JOptionPane.ERROR_MESSAGE, success);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SetRigidSemesterFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SetRigidSemesterFrame("default", "default","default").setVisible(true);
            }
        });
    }
